...
(:requirements :typing :conditional-effects :negative-preconditions :strips :disjunctive-preconditions :equality :fluents)
...
(:action move
    ...
    :precondition (and (whereabouts ?from ?char) (or (and (atloc ?from ?by) (atloc ?to ?by)) (and (= ?to ?by) (atloc ?from ?to)) (and (= ?from ?by) (atloc ?to ?from))))
